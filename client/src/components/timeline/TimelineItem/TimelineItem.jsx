...
import { localizedDayjs } from '../../../utils/localizedDayjs';
        ...
        <div className="flex-grow flex-shrink min-w-0">
          <p className="whitespace-nowrap overflow-ellipsis text-sm overflow-hidden">
            ...
            <Link className="pr-1 text-gray-500 hover:underline" to={`/posts/${post.id}`}>
              <time dateTime={localizedDayjs(post.createdAt).toISOString()}>
                {localizedDayjs(post.createdAt).locale('ja').format('LL')}
              </time>
            </Link>
          </p>
